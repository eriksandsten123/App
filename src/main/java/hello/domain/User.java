...
public class User implements Serializable {
    ...
    public void setPresentation(final String presentation) { this.presentation = presentation; }

    public Set<User> getFavorites() { return favorites; }

    public void setFavorites(final Set<User> favorites) { this.favorites = favorites; }
